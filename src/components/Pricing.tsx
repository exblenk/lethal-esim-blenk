        ...
        <Tabs defaultValue="saudi" className="w-full" dir="rtl">
          ...
          <TabsContent value="saudi" className="data-[state=active]:animate-fade-in">
            <Carousel 
              ...
              className="w-full"
            >
              <CarouselContent className="-ml-1 md:-ml-2 lg:-ml-3" style={{ touchAction: 'pan-y pinch-zoom' }}>
                {saudiPlans.map((plan, index) => (
                  <CarouselItem 
                    key={index} 
                    className="pl-1 md:pl-2 lg:pl-3 basis-[85%] sm:basis-[78%] md:basis-[60%] lg:basis-[45%] xl:basis-[38%]"
                  >
